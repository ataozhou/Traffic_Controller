...
from TestingRoadv2 import TestingRoadv2
from GUI import GUI
...
def create_environment():
	game = Road(length=length, prob = prob, numRoads = 1, keepalive = keepalive, wait_weight=wait_weight)
	...
	possible_actions = [idle, slowNS, speedNS, slowEW, speedEW, slowNSspeedEW, speedNSslowEW, speedBoth, slowBoth]
...
while epoch < num_epochs + 1:
	...
	if epoch % 10 == 0:
		saver.save(sess, "./PGModels/model.ckpt")
		print("Model Saved")
	epoch += 1
