...
def create_environment():
	game = Intersection(length=length, prob = prob, numRoads = 1, keepalive = keepalive, wait_weight=wait_weight)
	idle = [1,0,0,0,0]
	slowNS = [0,1,0,0,0]
	speedNS = [0,0,1,0,0]
	slowEW = [0,0,0,1,0]
	...
	possible_actions = [idle, slowNS, speedNS, slowEW, speedEW]
...
while epoch < num_epochs + 1:
	...
	if epoch % 10 == 0:
		saver.save(sess, "./PGModel/model.ckpt")
		print("Model Saved")
	epoch += 1
